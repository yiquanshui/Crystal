        ...
        protected override void Attack()
        {
            ...
            else
            {
                ...
                if (Env.Random.Next(5) > 0)
                {
                    ...
                    //Echo Shout
                    DelayedAction action = new DelayedAction(DelayedType.RangeDamage, Env.Time + 300, Target, damage, DefenceType.MACAgility, false);
                    ActionList.Add(action);
                }
                else
                {
                    ...
                    //Stomp
                    DelayedAction action = new DelayedAction(DelayedType.RangeDamage, Env.Time + 300, Target, damage, DefenceType.MACAgility, true);
                    ActionList.Add(action);
                }
            }
        }
